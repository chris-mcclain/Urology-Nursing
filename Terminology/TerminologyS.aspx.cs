...
{
    public partial class TerminologyS : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'S%' ORDER BY term";
            ...
            gvS.DataSource = terms;
            gvS.DataBind();

            gvS.HeaderRow.Cells[0].Text = "Term";
            gvS.HeaderRow.Cells[1].Text = "Definition";
