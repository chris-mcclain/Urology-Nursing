...
{
    public partial class TerminologyL : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'L%' ORDER BY term";
            ...
            gvL.DataSource = terms;
            gvL.DataBind();

            gvL.HeaderRow.Cells[0].Text = "Term";
            gvL.HeaderRow.Cells[1].Text = "Definition";
