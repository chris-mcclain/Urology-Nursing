...
{
    public partial class TerminologyN : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'N%' ORDER BY term";
            ...
            gvN.DataSource = terms;
            gvN.DataBind();

            gvN.HeaderRow.Cells[0].Text = "Term";
            gvN.HeaderRow.Cells[1].Text = "Definition";
