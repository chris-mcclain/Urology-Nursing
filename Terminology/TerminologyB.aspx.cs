...
{
    public partial class TerminologyB : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'B%' ORDER BY term";
            ...
            gvB.DataSource = terms;
            gvB.DataBind();

            gvB.HeaderRow.Cells[0].Text = "Term";
            gvB.HeaderRow.Cells[1].Text = "Definition";
