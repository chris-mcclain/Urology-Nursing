...
{
    public partial class TerminologyM : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'M%' ORDER BY term";
            ...
            gvM.DataSource = terms;
            gvM.DataBind();

            gvM.HeaderRow.Cells[0].Text = "Term";
            gvM.HeaderRow.Cells[1].Text = "Definition";
