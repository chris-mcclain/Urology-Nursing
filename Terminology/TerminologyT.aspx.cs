...
{
    public partial class TerminologyT : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'T%' ORDER BY term";
            ...
            gvT.DataSource = terms;
            gvT.DataBind();

            gvT.HeaderRow.Cells[0].Text = "Term";
            gvT.HeaderRow.Cells[1].Text = "Definition";
