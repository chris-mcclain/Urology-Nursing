...
{
    public partial class TerminologyF : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'F%' ORDER BY term";
            ...
            gvF.DataSource = terms;
            gvF.DataBind();

            gvF.HeaderRow.Cells[0].Text = "Term";
            gvF.HeaderRow.Cells[1].Text = "Definition";
