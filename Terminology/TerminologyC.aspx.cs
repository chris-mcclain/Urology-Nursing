...
{
    public partial class TerminologyC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'C%' ORDER BY term";
            ...
            gvC.DataSource = terms;
            gvC.DataBind();

            gvC.HeaderRow.Cells[0].Text = "Term";
            gvC.HeaderRow.Cells[1].Text = "Definition";
