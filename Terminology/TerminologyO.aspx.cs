...
{
    public partial class TerminologyO : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'O%' ORDER BY term";
            ...
            gvO.DataSource = terms;
            gvO.DataBind();

            gvO.HeaderRow.Cells[0].Text = "Term";
            gvO.HeaderRow.Cells[1].Text = "Definition";
