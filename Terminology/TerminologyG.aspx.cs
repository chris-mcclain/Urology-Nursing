...
{
    public partial class TerminologyG : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'G%' ORDER BY term";
            ...
            gvG.DataSource = terms;
            gvG.DataBind();

            gvG.HeaderRow.Cells[0].Text = "Term";
            gvG.HeaderRow.Cells[1].Text = "Definition";
