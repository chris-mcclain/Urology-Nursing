...
{
    public partial class TerminologyD : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'D%' ORDER BY term";
            ...
            gvD.DataSource = terms;
            gvD.DataBind();

            gvD.HeaderRow.Cells[0].Text = "Term";
            gvD.HeaderRow.Cells[1].Text = "Definition";
