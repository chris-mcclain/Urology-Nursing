...
{
    public partial class TerminologyP : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'P%' ORDER BY term";
            ...
            gvP.DataSource = terms;
            gvP.DataBind();

            gvP.HeaderRow.Cells[0].Text = "Term";
            gvP.HeaderRow.Cells[1].Text = "Definition";
