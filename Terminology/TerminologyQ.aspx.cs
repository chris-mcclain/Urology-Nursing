...
{
    public partial class TerminologyQ : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'Q%' ORDER BY term";
                ...
                gvQ.DataSource = terms;
                gvQ.DataBind();

                gvQ.HeaderRow.Cells[0].Text = "Term";
                gvQ.HeaderRow.Cells[1].Text = "Definition";
