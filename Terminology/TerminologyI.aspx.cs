...
{
    public partial class TerminologyI : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'I%' ORDER BY term";
            ...
            gvI.DataSource = terms;
            gvI.DataBind();

            gvI.HeaderRow.Cells[0].Text = "Term";
            gvI.HeaderRow.Cells[1].Text = "Definition";
