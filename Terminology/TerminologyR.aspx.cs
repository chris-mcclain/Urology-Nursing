...
{
    public partial class TerminologyR : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'R%' ORDER BY term";
            ...
            gvR.DataSource = terms;
            gvR.DataBind();

            gvR.HeaderRow.Cells[0].Text = "Term";
            gvR.HeaderRow.Cells[1].Text = "Definition";
