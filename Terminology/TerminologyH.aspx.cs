...
{
    public partial class TerminologyH : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            // Create a SELECT statement.
            String select = "SELECT term, termDefinition FROM Terminology WHERE term LIKE 'H%' ORDER BY term";
            ...
            gvH.DataSource = terms;
            gvH.DataBind();

            gvH.HeaderRow.Cells[0].Text = "Term";
            gvH.HeaderRow.Cells[1].Text = "Definition";
